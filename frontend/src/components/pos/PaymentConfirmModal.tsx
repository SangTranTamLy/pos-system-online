        ...
        <div className="flex items-center justify-between border-b border-slate-200 px-6 py-5">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Đơn hàng sẽ được ghi nhận trực tiếp vào hệ thống MySQL.
            </p>
          </div>
          <button
            type="button"
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-5">
            <div className="space-y-3">
              ...
              <div className="flex justify-between gap-4 text-sm text-slate-600">
                ...
                <span className="font-extrabold text-[#0b1c30]">{getPaymentMethodLabel(paymentMethod)}</span>
              </div>
            </div>
          </section>

          <div className="rounded-2xl border border-orange-100 bg-orange-50 p-4 text-sm font-semibold text-[#92400e]">
            <p>Nhấn "Xác nhận" để ghi nhận thanh toán vào database thật và tạo hoá đơn bán hàng.</p>
          </div>
